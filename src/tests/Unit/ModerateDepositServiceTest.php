...
class ModerateDepositServiceTest extends TestCase
{
    ...
    public function testDepositBlock()
    {
    ...
    public function testDepositBlockThenComplete()
    {
        $initWallet = $this->user->wallet;
        $walletTransaction = WalletTransaction::factory()->create([
            'user_id' => $this->user->id,
    ...
    public function testDepositBlockThenReject()
    {
        $initWallet = $this->user->wallet;
        $walletTransaction = WalletTransaction::factory()->create([
            'user_id' => $this->user->id,
